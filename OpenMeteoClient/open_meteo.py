...
class OpenMeteo():
    ...
    def __get_current_location(self, location):
        ...
        return {"location":location,"code": location.cod, "data":{"time":str(current_time), "temperature": current["temperature"], "precipitation": data["hourly"]["precipitation_probability"][current_time.hour], "windspeed":current["windspeed"], "uv_index_max": data["daily"]["uv_index_max"][0]}}
